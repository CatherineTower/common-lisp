...
(p:define-test "Color > Convert > xyY"
  ...
  (p:is color=
        ...
        (i:convert-color
         (i:xyy 0.22882279463372762d0 0.2756865588051985d0 0.49140627521213487d0)
         'i:xyz))
  (p:is color=
  ...
  (p:is color=
        (i:rgb 0.3738271623298214d0 0.8283234225116588d0 0.9785855052736638d0
               :space 'i:bt470-pal/secam)
        (i:convert-color
         (i:xyy 0.22882279463372762d0 0.2756865588051985d0 0.49140627521213487d0)
         (i:make-color 'i:rgb :space 'i:bt470-pal/secam)))
  (p:is color=
        (i:rgb 0.1603738273161353d0 0.7678213897193806d0 0.9683096929881114d0
               :space 'i:bt709)
        (i:convert-color
         (i:xyy 0.22882279463372762d0 0.2756865588051985d0 0.49140627521213487d0)
