...
(p:define-test "Color > Convert > Lab"
  ...
  (p:is color=
        ...
        (i:convert-color
         (i:lab 77.03361122337391d0 -88.2832867107874d0 -52.38837618088325d0)
         'i:xyz))
  (p:is color=
  ...
  (p:is color=
        (i:rgb -0.8481270756444532d0 0.9221047356600448d0 1.0982469230202312d0
               :space 'i:bt470-pal/secam)
        (i:convert-color
         (i:lab 77.03361122337391d0 -88.2832867107874d0 -52.38837618088325d0)
         (i:make-color 'i:rgb :space 'i:bt470-pal/secam)))
  (p:is color=
        (i:rgb -3.1201919277406680d0 0.8932493212393352d0 1.1351995910262929d0
               :space 'i:bt709)
        (i:convert-color
         (i:lab 77.03361122337391d0 -88.2832867107874d0 -52.38837618088325d0)
