...
(declaim (inline =))
(defun = (vec1 vec2 &key (rel 1f-7) (abs rel))
...
(defun sqrt! (out vec)
  ...
  (declare (optimize speed))
  (com:cwset 2 out vec (cl:sqrt (the (u:f32 0f0) vec)))
  out)
...
VEC."
  (declare (optimize speed))
  (com:cwset 2 out vec (cl:asin (the (u:f32 -1f0 1f0) vec)))
  out)
...
vector VEC."
  (declare (optimize speed))
  (com:cwset 2 out vec (cl:acos (the (u:f32 -1f0 1f0) vec)))
  out)
